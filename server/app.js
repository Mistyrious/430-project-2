...
const dbURI = process.env.MONGODB_URI || 'mongodb://127.0.0.1/NoteManager';
...
app.use(session({
  ...
  secret: 'Not(e) My Problem', // private string used as a seed for hashing/creating session keys
